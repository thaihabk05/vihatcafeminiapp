...
const Subscription: FC = () => {
  ...
  return (
    <Box className="m-4" onClick={requestUserInfo}>
      ...
      >
        <Text.Title className="font-bold">Thành viên OmiCafé · VIHAT</Text.Title>
        <Text size="xxSmall">
          Tích điểm tự động qua Zalo · Đổi voucher · Liên kết OmiCall CRM
        </Text>
      </Box>
    </Box>
  );
